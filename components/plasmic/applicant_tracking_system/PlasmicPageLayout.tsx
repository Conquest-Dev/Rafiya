...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: Ln2tCX6ptptG/css

import LoadingIcon from "./icons/PlasmicIcon__Loading"; // plasmic-import: KknmGGCvoHmB/icon
import Icon8Icon from "./icons/PlasmicIcon__Icon8"; // plasmic-import: iqukWNnqtUx9/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon8Icon
          className={classNames(projectcss.all, sty.svg__vUipc)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox___9YgZo)}>
                <LoadingIcon
                  className={classNames(projectcss.all, sty.svg__qdqjj)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__hmwNc)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__mFvWg)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
