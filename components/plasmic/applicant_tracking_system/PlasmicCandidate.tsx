...
import sty from "./PlasmicCandidate.module.css"; // plasmic-import: 8eTek5Kk2DcY/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    positions: usePlasmicDataOp(() => {
      return {
        ...
        opId: "ef86dab8-1d69-4365-bcb2-2fbb0e2a067b",
        userArgs: {},
        cacheKey: `plasmic.$.ef86dab8-1d69-4365-bcb2-2fbb0e2a067b.$.`,
    ...
    candidate: usePlasmicDataOp(() => {
      return {
        sourceId: "fZbzzfQKdR4pvGU9HptEUD",
        opId: "efb94fce-1f10-4bd3-9e4e-7ce01a25837f",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.efb94fce-1f10-4bd3-9e4e-7ce01a25837f.$.`,
        invalidatedKeys: null,
        roleId: "c246114d-0e1f-40f8-9205-fb602495e509"
      };
    })
                        ...
                        $steps["tutorialdbUpdateMany"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "fZbzzfQKdR4pvGU9HptEUD",
                                  opId: "a3136f4a-6a95-48ee-9386-187e92375134",
                                  userArgs: {
