...
import Card from "../../Card"; // plasmic-import: zngwF8VpMbkA/component
...
import sty from "./PlasmicPosition.module.css"; // plasmic-import: BSjelx751w2N/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    position: usePlasmicDataOp(() => {
      return {
        ...
        opId: "48b50a61-e35f-4a8c-8760-115507b72ab4",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.48b50a61-e35f-4a8c-8760-115507b72ab4.$.`,
    ...
    candidates: usePlasmicDataOp(() => {
      return {
        sourceId: "fZbzzfQKdR4pvGU9HptEUD",
        opId: "a2ff8622-10c1-4f46-9842-5fa22aaa1cb4",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.a2ff8622-10c1-4f46-9842-5fa22aaa1cb4.$.`,
        invalidatedKeys: null,
        roleId: "c246114d-0e1f-40f8-9205-fb602495e509"
      };
    })
            ...
            <DataCtxReader__>
              {$ctx => (
                ...
                >
                        ...
                        $steps["tutorialdbUpdateMany"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "fZbzzfQKdR4pvGU9HptEUD",
                                  opId: "1c1aa292-c86a-44b9-8aae-a1f5d2546f68",
                                  userArgs: {
                  ...
                  <Card
                    className={classNames("__wab_instance", sty.card__aT1Tq)}
                    noTitle={true}
                  >
                    <RichDetails
                  ...
                  <Card
                    className={classNames("__wab_instance", sty.card__q5JYa)}
                    title={
                      <h4
